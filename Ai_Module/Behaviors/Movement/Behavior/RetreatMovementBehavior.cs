...
{
    /// <summary>
    /// AI movement behavior that makes an Vehicle retreat from the visible screen after attacking.
    /// </summary>

    public class RetreatMovementBehavior : IMovementBehavior
    {
        ...
        public void Execute(IWorldObject worldObject)
        {
            ...
            var direction = vehicle.IsFacingRight ? Vector2.left : Vector2.right;
